...
case ILI9325D_16:
	...
	LCD_Write_COM_DATA(0x10, 0x1290); // SAP, BT[3:0], AP, DSTB, SLP, STB  
	LCD_Write_COM_DATA(0x11, 0x0227); // Set DC1[2:0], DC0[2:0], VC[2:0]  
	delay(50); // Delay 50ms  
	LCD_Write_COM_DATA(0x12, 0x001D); // 0012  
	delay(50); // Delay 50ms  
	LCD_Write_COM_DATA(0x13, 0x1500); // VDV[4:0] for VCOM amplitude  
	LCD_Write_COM_DATA(0x29, 0x0018); // 04  VCM[5:0] for VCOMH  
	LCD_Write_COM_DATA(0x2B, 0x000D); // Set Frame Rate  
	delay(50); // Delay 50ms  
	
	// ----------- Adjust the Gamma Curve ----------//  
	LCD_Write_COM_DATA(0x30, 0x0004);  
	LCD_Write_COM_DATA(0x31, 0x0307);  
	LCD_Write_COM_DATA(0x32, 0x0002);  
	LCD_Write_COM_DATA(0x35, 0x0206);  
	LCD_Write_COM_DATA(0x36, 0x0408);  
	LCD_Write_COM_DATA(0x37, 0x0507);  
	LCD_Write_COM_DATA(0x38, 0x0204);  
	LCD_Write_COM_DATA(0x39, 0x0707);  
	LCD_Write_COM_DATA(0x3C, 0x0405);  
	LCD_Write_COM_DATA(0x3D, 0x0F02);  
	//------------------ Set GRAM area ---------------//  
