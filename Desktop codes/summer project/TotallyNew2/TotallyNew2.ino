...
////////////////////////////////////////////////////Search Command/////////////////////////////////////////////////////////////////////////
byte SearchCommand[]={0xEF,0x01,0xFF,0xFF,0xFF,0xFF,0x01,0x00,0x08,0x04,BufferId,0x00,BasePageID,0x00,PageID,0x00,CheckSum};
...
void SetSearchParameters()
{
 ...
 SearchCommand[12]=BasePageID;
 SearchCommand[14]=PageID;
 int sum=0;
 for(int i=6;i<=14;i++)
 {
   sum+=SearchCommand[i];
