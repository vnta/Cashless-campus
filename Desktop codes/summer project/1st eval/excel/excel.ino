...
void logoScreen()
{
  ...
  myGLCD.print("MESS AUTOMATION",30,20);
  myGLCD.drawBitmap (100, 60, 115, 115, logo);
  myGLCD.print("Tap To continue...",20,190);
...
{ while (true)
{
  ...
  if ((y>=10) && (y<=60))  // Upper row
      { if ((x<=250)&&(x>=210)) { coupon[0+p].quant++;}
        if ((x>=270)&&(x<=310)) { if (coupon[0+p].quant>0)  coupon[0+p].quant--;}
      }
      
   if ((y>=70) && (y<=120))  
      { if ((x<=250)&&(x>=210)) { coupon[1+p].quant++;}
        if ((x>=270)&&(x<=310)) { if (coupon[1+p].quant>0)  coupon[1+p].quant--;}
      }
      
      
    if ((y>=130) && (y<=180))  
      { if ((x<=250)&&(x>=210)) { coupon[2+p].quant++;}
        if ((x>=270)&&(x<=310)) { if (coupon[2+p].quant>0)  coupon[2+p].quant--;}
      }
