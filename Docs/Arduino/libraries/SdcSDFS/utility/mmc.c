...
/*
	Patch for SdcSDFS is done by Sungjune Lee. For more information check
	the SDC_PATCH define.
*/
...
#define TMR_CONFIG()		do{\
							TCCR2A = _BV(WGM21);\
							TCCR2B = _BV(CS22) | _BV(CS21) | _BV(CS20);\
							TIMSK2 = _BV(OCIE2A);\
							OCR2A = 156;\
							}while(0)
#define TMR_INT_VECTOR		TIMER2_COMPA_vect
#define SOCKWP				(0)
#define SOCKINS				(1)

	#if defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__)

	#define SPI_CONFIG()	do{\
...
{
#if SDC_PATCH
	// do your powwer_status function here
	return 1;
#else
...
{
#if SDC_PATCH
	// do your power_on function here
	CS_HIGH();
	SPI_CONFIG();
	TMR_CONFIG();
#else
...
{
#if SDC_PATCH
	// do your power_off function here
#else
