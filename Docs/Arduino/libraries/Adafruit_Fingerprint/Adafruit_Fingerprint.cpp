...
boolean Adafruit_Fingerprint::verifyPassword(void) {
  ...
  Serial.println(len); Serial.print(packet[0]);
...
uint8_t Adafruit_Fingerprint::upChar(uint8_t slot) {
...
uint8_t Adafruit_Fingerprint::downChar(uint8_t slot) {
...
uint8_t Adafruit_Fingerprint::Match(void) {
